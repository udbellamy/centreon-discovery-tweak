...
LOG_FILE = "/usr/share/centreon-discovery" + "/log/"+time.strftime('%Y%m',time.localtime())  +"_Central_DiscoveryAgent.log"
...
def connectToDB():
	...
	#fd.close()	
	db=MySQLdb.connect(host="localhost",user="centreon",passwd="centreon",db="centreon")
	return db
