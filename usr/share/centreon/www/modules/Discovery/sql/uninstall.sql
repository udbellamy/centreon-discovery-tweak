...
DELETE FROM `centreon`.`topology` WHERE `topology_page` = '612';
DELETE FROM `centreon`.`topology` WHERE `topology_page` = '61201';
DELETE FROM `centreon`.`topology` WHERE `topology_page` = '61202';
DELETE FROM `centreon`.`topology` WHERE `topology_page` = '61203';
DELETE FROM `centreon`.`topology` WHERE `topology_page` = '61204';
DELETE FROM `centreon`.`topology` WHERE `topology_page` = '61205';
...
DROP TABLE `centreon`.`mod_discovery_results`;
...
DROP TABLE `centreon`.`mod_discovery_template_os_relation`;
DROP TABLE `centreon`.`mod_discovery_config`;
