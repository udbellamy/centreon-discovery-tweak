...
-- pour snmp
  ...
  `snmp_v3privtype` varchar(256) COLLATE utf8_bin NOT NULL DEFAULT 'AES',
...
INSERT INTO `centreon`.`mod_discovery_config` (`host_exists_color`, `ip_exists_color`, `host_missing_color`, `consider_fqdn`) VALUES
